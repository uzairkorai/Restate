            ...
            <section id="filter">
                <div className="inside">
                    ...
                    <div className="filters extras">
                        ...
                        <label htmlFor="extras"><span>Elevators</span><input name="elevator" value="elevator" type="checkbox" onChange={this.props.change} /></label>
                        <label htmlFor="extras"><span>Swimming Poll</span><input name="swimming_pool" value="swimming-pool" type="checkbox" onChange={this.props.change} /></label>
                        ...
                        <label htmlFor="extras"><span>Gym</span><input name="gym" value="gym" type="checkbox" onChange={this.props.change} /></label>
                    </div>
                </div>
            </section>
        )
